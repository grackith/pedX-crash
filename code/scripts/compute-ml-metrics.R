...
predictions = read.table("~/Library/CloudStorage/GoogleDrive-gad9515@nyu.edu/Shared drives/HumanFuel/1 NHTSA Ped Crash Sept 2023 /C.5 Conduct analysis plan/code/4 ml/ml results/1 NHTSA Ped Crash.local-results/all_ml_predictions.csv", stringsAsFactors = TRUE, header = TRUE, sep=",")
...
write.csv(metrics, "~/Library/CloudStorage/GoogleDrive-gad9515@nyu.edu/Shared drives/HumanFuel/1 NHTSA Ped Crash Sept 2023 /C.5 Conduct analysis plan/code/4 ml/ml results/1 NHTSA Ped Crash.local-results/ml_metrics_results.csv", row.names = FALSE)
